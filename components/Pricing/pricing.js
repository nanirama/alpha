...
const plans = [
  {
    ...
    priceYearly: 56,
    mainFeatures: [
      { id: 1, value: 'Presentation writing' },
      { id: 2, value: 'High-level market research' },
      { id: 3, value: 'Standard financial model template' },
      { id: 4, value: 'Revisions: 1 major, 1 minor' },
    ],
  },
  {
    title: 'Sprout',
    ...
    priceYearly: 220,
    mainFeatures: [
      { id: 1, value: 'Premium presentation design' },
      { id: 2, value: 'High-level competition research' },
      { id: 3, value: 'Customized questions for VC-meeting' },
      { id: 4, value: 'Revisions: 1 additional minor revision' },
      { id: 5, value: '1 hour consultation with a specialist/startup consultant/angel investor' },
  ...
  },
  {
    ...
    priceYearly: 140,
    mainFeatures: [
      { id: 1, value: 'High-end presentation design' },
      { id: 2, value: 'Bottom-up market sizing (3 geographies, 3 customer segments)' },
      { id: 3, value: 'Detailed competitive benchmarking' },
      { id: 4, value: 'Customized financial model' },
      { id: 5, value: 'Valuation (2-3 relevant methods) and cap table' },
    ],
  },
]
const features = [
      ...
      <div className="relative bg-indigo-600">
        ...
        <div className="relative max-w-2xl mx-auto pt-16 px-4 text-center sm:pt-32 sm:px-6 lg:max-w-7xl lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-6xl">
            <span className="block lg:inline">Transparent, startup-friendly pricing.</span>
          </h1>
          <p className="mt-4 text-xl text-indigo-100">
          Payment terms: 40% down-payment, remaining milestone-based. 
          </p>
        </div>
