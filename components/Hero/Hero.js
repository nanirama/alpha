...
import logo from "../assets/images/workflow.png";
			...
			<div className="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
						...
						<div className="mt-20">
							...
							<div className="mt-6 sm:max-w-xl">
								<h1 className="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">
									Pitch Deck for SaaS that helps you raise funds faster and
									smarter
								</h1>
								<p className="mt-6 text-xl text-gray-500">
									AlphaValley Pitch Deck for SaaS is a bespoke service for
									Software entrepreneurs. We craft VC-grade pitch decks for SaaS
									founders like you. Save time focusing on your core growth
									metrics and leave the heavy-lifting of pitch deck development
									to us. SaaS entrepreneurs love our meticulous process and
									co-founder like approach.
								</p>
							</div>
				...
				<div className="sm:mx-auto sm:max-w-3xl sm:px-6">
					<div className="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
						...
						<div className="bg-red-500 relative pl-4 -mr-40 sm:mx-auto overflow-hidden sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-12">
							<Image
